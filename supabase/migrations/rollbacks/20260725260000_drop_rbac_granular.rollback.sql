-- ══════════════════════════════════════════════════════════════════════════════
-- ROLLBACK: ARCH-RBAC-02 AC3 (20260725260000)
-- Restaura o schema RBAC granular (tabelas vazias — zero perda de dados).
-- Reproduz o conteúdo de 20260423009000_tenant_role_permissions.sql.
-- ══════════════════════════════════════════════════════════════════════════════

BEGIN;

-- ─── 1. Recriar enum feature_key ─────────────────────────────────────────────
DO $$
BEGIN
...
-- ─── 3. Recriar tenant_role_permissions ──────────────────────────────────────
...
-- ─── 4. Restaurar coluna role_id em settings_users ───────────────────────────
...
-- ─── 5. Restaurar função seed_default_tenant_roles ───────────────────────────
