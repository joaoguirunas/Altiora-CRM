...
const SUPABASE_URL = 'https://ohzwetkaazgxafubzvop.supabase.co';
const SUPABASE_ANON_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9oendldGthYXpneGFmdWJ6dm9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTAxMjk5MjQsImV4cCI6MjA2NTcwNTkyNH0.9eaERm2xH_GtB9B1YxLR2ku89qKoVu8WXRuU6YGFaNc';
...
if (!SUPABASE_SERVICE_KEY) {
  ...
  console.error('   Export antes de rodar: export SUPABASE_SERVICE_ROLE_KEY=xxx');
  process.exit(1);
}
