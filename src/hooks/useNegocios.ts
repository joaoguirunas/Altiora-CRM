...
// Update negocio
export const useUpdateNegocio = (options?: { entityLabel?: string }) => {
  const queryClient = useQueryClient();
  // Label dinâmico para mensagens de toast (AC2 — ALTIORA-04)
  const entityLabel = options?.entityLabel ?? 'Negócio';
