...
import AltioraIndicadores from "@/pages/AltioraIndicadores";
  ...
  return (
    <Routes>
      ...
      <Route path="/crm" element={
        ...
        {/* ALTIORA-24: Indicadores operacionais */}
        <Route path="altiora/indicadores" element={
          <ModuleProtectedRoute moduleKey="negocios">
            <SectionErrorBoundary section="Altiora Indicadores">
              <AltioraIndicadores />
            </SectionErrorBoundary>
          </ModuleProtectedRoute>
        } />
