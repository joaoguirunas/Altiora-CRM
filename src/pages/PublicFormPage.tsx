...
import { Loader2, CheckCircle2, AlertCircle, Send, ChevronRight, ChevronLeft, ChevronDown, ExternalLink } from "lucide-react";
...
function getFormStyle(s: LpFormSettings) {
  ...
  return {
    ...
    buttonTextColor: st.button_text_color ?? "#ffffff",
...
function PublicField({
  ...
  if (field.type === "textarea") {
    ...
    input = (
      <SelectWrap arrowColor={fs.labelColor ?? undefined}>
        <select
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className={borderClass}
          style={{ ...inputStyle, appearance: "none", WebkitAppearance: "none", paddingRight: "2.25rem", cursor: "pointer" }}
        >
