...
export const WhatsappTemplatesConfig: React.FC = () => {
      ...
      <div className="space-y-4">
        ...
        {!templates || templates.length === 0 ? (
          ...
          <div className="rounded-xl border border-white/10 overflow-hidden">
            {/* Table header */}
            <div className="grid grid-cols-[1fr_auto_auto_auto_auto_auto] gap-0 px-4 py-2 bg-white/[0.03] border-b border-white/10">
              ...
              {filteredTemplates.map((template) => {
                ...
                return (
                  <div
                    key={template.id}
                    className={cn(
                      "grid grid-cols-[1fr_auto_auto_auto_auto_auto] gap-0 px-4 py-3 items-center hover:bg-white/[0.03] transition-colors",
