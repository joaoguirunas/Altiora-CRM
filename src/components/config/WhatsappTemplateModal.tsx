...
export const WhatsappTemplateModal: React.FC<WhatsappTemplateModalProps> = ({
  ...
  const handleDelete = async () => {
    if (!template || !defaultChannel) return;
    setDeleting(true);
    try {
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  disabled={deleting || !defaultChannel}
                >
                  {deleting
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    O template <strong>{template.nome}</strong> será excluído da Meta e desativado localmente. Essa ação não pode ser desfeita.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
